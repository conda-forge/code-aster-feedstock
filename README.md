...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cafs-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cafs-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cafs-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `code-aster` available on your platform:
...
```
pixi search code-aster --channel conda-forge
```
